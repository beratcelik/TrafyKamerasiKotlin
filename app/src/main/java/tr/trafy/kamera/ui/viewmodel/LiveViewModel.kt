...
import tr.trafy.kamera.data.capture.AllwinnerCaptureRepository
import tr.trafy.kamera.data.capture.AllwinnerCaptureResult
import tr.trafy.kamera.data.media.EeasytechLiveRepository
import tr.trafy.kamera.data.media.GeneralplusLiveRepository
import tr.trafy.kamera.data.media.MstarLiveRepository
...
class LiveViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val allwinnerLiveRepo =
        tr.trafy.kamera.data.media.AllwinnerLiveRepository(application)
     ...
     * [tr.trafy.kamera.ui.viewmodel.MediaViewModel] and
     * [tr.trafy.kamera.ui.viewmodel.SettingsViewModel] —
    ...
    private fun hiDvrCameraLabel(key: String): String = getApplication<Application>().getString(
        when (key) {
            "Back"   -> tr.trafy.kamera.R.string.media_tab_back
            "Inside" -> tr.trafy.kamera.R.string.media_tab_inside
            else     -> tr.trafy.kamera.R.string.media_tab_front
        }
    )
