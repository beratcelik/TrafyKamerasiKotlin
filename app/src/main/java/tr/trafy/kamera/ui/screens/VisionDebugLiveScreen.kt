...
import tr.trafy.kamera.ui.viewmodel.LiveState
import tr.trafy.kamera.ui.viewmodel.VisionDebugLiveViewModel
...
private fun StatusLine(
    state: LiveState,
    frameCount: Int,
    latency: tr.trafy.kamera.data.vision.util.LatencyHistogram.Snapshot,
) {
    Card(
        shape = RoundedCornerShape(12.dp),
        colors = CardDefaults.cardColors(containerColor = ColorSurface),
