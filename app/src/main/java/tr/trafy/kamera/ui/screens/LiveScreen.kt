...
import tr.trafy.kamera.ui.viewmodel.CaptureKind
import tr.trafy.kamera.ui.viewmodel.CaptureState
import tr.trafy.kamera.ui.viewmodel.LiveUiState
...
private fun AllwinnerLiveView(
    ...
    aiScene: tr.trafy.kamera.data.vision.TrackedScene?,
    isLandscape: Boolean,
            ...
            when {
                ...
                state.localFileUri == null || state.buffering -> {
                    androidx.compose.material3.CircularProgressIndicator(
                        color = tr.trafy.kamera.ui.theme.ColorPrimary,
                    )
                }
                else -> {
                    ...
                    androidx.compose.runtime.key(state.camid) {
                        tr.trafy.kamera.ui.components.AllwinnerFilePlayer(
...
private fun RtspPlayer(
    ...
    overlayScene: tr.trafy.kamera.data.vision.TrackedScene? = null,
) {
