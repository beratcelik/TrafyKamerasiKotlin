...
class OverlayVideoEncoder(
    ...
    private fun drawPlateBillboards(
        ...
        val tracksByTrackId: Map<Int, com.example.trafykamerasikotlin.data.vision.tracker.TrackedDetection> =
    ...
    private fun drawDistancesOnVehicles(scene: TrackedScene, sx: Float, sy: Float) {
        ...
        val plateByTrackId = HashMap<Int, com.example.trafykamerasikotlin.data.vision.PlateDetection>(plates.size)
        val plateByDetIdx  = HashMap<Int, com.example.trafykamerasikotlin.data.vision.PlateDetection>(plates.size)
        for (p in plates) {
     ...
     */
    private fun shouldLockPlate(p: com.example.trafykamerasikotlin.data.vision.PlateDetection): Boolean {
    ...
    private fun parentBboxOf(
        p: com.example.trafykamerasikotlin.data.vision.PlateDetection,
        detections: List<com.example.trafykamerasikotlin.data.vision.Detection>,
        tracks: List<com.example.trafykamerasikotlin.data.vision.tracker.TrackedDetection>?,
    ): RectF? {
