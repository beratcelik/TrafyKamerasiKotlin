...
import tr.trafy.kamera.ui.viewmodel.VisionDebugState
import tr.trafy.kamera.ui.viewmodel.VisionDebugViewModel
...
private fun FrameWithOverlay(
    bitmap: Bitmap?,
    scene: tr.trafy.kamera.data.vision.TrackedScene?,
    modifier: Modifier = Modifier,
) {
...
@Composable
private fun LatencyCard(snap: tr.trafy.kamera.data.vision.util.LatencyHistogram.Snapshot) {
    SectionCard {
        Text(
...
private fun ModelTelemetryCard(
    t: tr.trafy.kamera.data.vision.ModelTelemetry,
