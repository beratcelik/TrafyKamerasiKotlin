...
class EeasytechSettingsRepository(private val context: Context) {
    ...
    suspend fun exitSettings(deviceIp: String) {
        if (com.example.trafykamerasikotlin.data.media.EeasytechCleanupLock.ranRecently()) {
        ...
        com.example.trafykamerasikotlin.data.media.EeasytechCleanupLock.mutex.withLock {
            ...
            com.example.trafykamerasikotlin.data.media.EeasytechCleanupLock.markCompletion()
        }
    }
