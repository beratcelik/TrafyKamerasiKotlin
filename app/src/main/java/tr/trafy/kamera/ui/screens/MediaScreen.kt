...
import tr.trafy.kamera.data.media.rememberDashcamImageLoader
...
import tr.trafy.kamera.ui.viewmodel.DownloadState
import tr.trafy.kamera.ui.viewmodel.MediaUiState
import tr.trafy.kamera.ui.viewmodel.MediaUserMessage
...
import tr.trafy.kamera.data.media.MjpegRtspPlayer
import tr.trafy.kamera.ui.components.AllwinnerFilePlayer
import tr.trafy.kamera.ui.components.BoundingBoxOverlay
import tr.trafy.kamera.ui.viewmodel.LiveVisionOverlayViewModel
...
private fun AllwinnerPlaybackOverlay(url: String, onDismiss: () -> Unit) {
    ...
    val (aiOverlayEnabled, setAiOverlay) =
        tr.trafy.kamera.data.settings.rememberAiOverlayPreference()
    ...
    Box(
        ...
        if (tr.trafy.kamera.BuildConfig.DEBUG) {
 ...
 */
@Composable
private fun IjkVideoPlayerOverlay(
    url: String,
    network: Network?,
    onDismiss: () -> Unit,
) {
