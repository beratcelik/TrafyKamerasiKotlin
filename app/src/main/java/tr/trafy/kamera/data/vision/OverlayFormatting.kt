package tr.trafy.kamera.data.vision
 ...
 * Compose overlay ([tr.trafy.kamera.ui.components.BoundingBoxOverlay])
 * and the offline burn-in renderer
 * ([tr.trafy.kamera.data.video.OverlayVideoEncoder]) so both
